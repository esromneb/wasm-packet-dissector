...
new_dissector_handle(enum dissector_e type, void *dissector, const int proto, const char *name, void *cb_data)
{
	...
	handle->dissector_func	= (void*)dissector;
...
{
	return new_dissector_handle(DISSECTOR_TYPE_SIMPLE, (void*)dissector, proto, NULL, NULL);
}
...
{
	return new_dissector_handle(DISSECTOR_TYPE_SIMPLE, (void*)dissector, proto, name, NULL);
}
...
register_dissector(const char *name, dissector_t dissector, const int proto)
{
	...
	handle = new_dissector_handle(DISSECTOR_TYPE_SIMPLE, (void*)dissector, proto, name, NULL);
...
register_dissector_with_data(const char *name, dissector_cb_t dissector, const int proto, void *cb_data)
{
	...
	handle = new_dissector_handle(DISSECTOR_TYPE_CALLBACK, (void*)dissector, proto, name, cb_data);
