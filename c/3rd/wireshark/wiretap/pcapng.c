        ...
        switch (oh.option_code) {
            ...
            case(OPT_COMMENT):
                if (oh.option_length > 0 && oh.option_length < opt_cont_buf_len) {
                    ...
                    wtap_block_add_string_option(wblock->block, OPT_COMMENT, (const gchar*)option_content, oh.option_length);
            ...
            case(OPT_SHB_HARDWARE):
                if (oh.option_length > 0 && oh.option_length < opt_cont_buf_len) {
                    ...
                    wtap_block_add_string_option(wblock->block, OPT_SHB_HARDWARE, (const gchar*)option_content, oh.option_length);
            ...
            case(OPT_SHB_OS):
                if (oh.option_length > 0 && oh.option_length < opt_cont_buf_len) {
                    tmp_content = g_strndup((char *)option_content, oh.option_length);
                    /* Fails with multiple options; we silently ignore the failure */
                    wtap_block_add_string_option(wblock->block, OPT_SHB_OS, (const gchar*)option_content, oh.option_length);
            ...
            case(OPT_SHB_USERAPPL):
                if (oh.option_length > 0 && oh.option_length < opt_cont_buf_len) {
                    tmp_content = g_strndup((char *)option_content, oh.option_length);
                    /* Fails with multiple options; we silently ignore the failure */
                    wtap_block_add_string_option(wblock->block, OPT_SHB_USERAPPL, (const gchar*)option_content, oh.option_length);
    ...
    while (to_read != 0) {
        ...
        switch (oh.option_code) {
            ...
            case(OPT_COMMENT): /* opt_comment */
                if (oh.option_length > 0 && oh.option_length < opt_cont_buf_len) {
                    tmp_content = g_strndup((char *)option_content, oh.option_length);
                    wtap_block_add_string_option(wblock->block, oh.option_code, (const gchar*)option_content, oh.option_length);
    ...
    wtapng_block_t *wblock, int *err, gchar **err_info)
{
    ...
    dsb_mand->secrets_data = (unsigned char *)g_malloc0(dsb_mand->secrets_len);
